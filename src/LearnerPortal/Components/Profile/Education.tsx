                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="education-card">
                                                <div className="left">
                                                    <h3>Bachelor of Education (B.Ed) • Education</h3>
                                        ...
                                        <div className="row">
                                            <div className="col-md-4">
                                                <div className="ugrad-input-form-group select">
                                                    <label className='ugrad-label'>University/College Name</label>
                                                    <select className="ugrad-select" disabled={!isEditing}>
                                                        <option value="" selected disabled>University of Education</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-4">
                                                <div className="ugrad-input-form-group select">
                                                    <label className='ugrad-label'>Qualification</label>
                                                    <select className="ugrad-select" disabled={!isEditing}>
                                                        <option value="" selected disabled>Bachelors</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-4">
                                                <div className="ugrad-input-form-group">
                                                    <label className='ugrad-label'>Course Name</label>
                                                    <input type="text" className='ugrad-input' placeholder='Course Name' value={'Bachelor of Education (B.Ed)'} disabled={!isEditing} />
                                                </div>
                                            </div>

                                            <div className="col-md-4">
                                                <div className="ugrad-input-form-group">
                                                    <label className='ugrad-label'>Specialization</label>
                                                    <input type="text" className='ugrad-input' placeholder='Specialization' value={'Artificial Intelligence'} disabled={!isEditing} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-4">
                                                <div className="ugrad-input-form-group">
                                                    <label className='ugrad-label'>End Date</label>
                                                    <input type="date" className='ugrad-input' value={'2025-01-12'} disabled={!isEditing} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <div className="ugrad-input-form-group select">
                                                    <label className='ugrad-label'>Course Type</label>
                                                    <select className="ugrad-select" disabled={!isEditing}>
                                            ...
                                            <div className="col-md-6">
                                                <div className="ugrad-input-form-group">
                                                    <label className='ugrad-label'>Grade</label>
                                                    <input type="text" className='ugrad-input' placeholder='Grade' value={'3.8 GPA'} disabled={!isEditing} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-12">
                                                <div className="d-flex align-items-center justify-content-end gap-2 flex-column">
                                                    <button type="submit" className='save-btn w-100'>Save & Add  Education</button>
