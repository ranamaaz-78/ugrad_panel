...
import InstructorImage5 from "../assets/instructorImage5.jpg";
...
export const Images = {
  ...
  InstructorImage4: InstructorImage4,
  InstructorImage5: InstructorImage5,
  ...
  ProgramHomePatternLeft: ProgramHomePatternLeft,
  ProgramHomePatternRight: ProgramHomePatternRight,
  HomeProgramImage1: HomeProgramImage1,
  HomeProgramImage2: HomeProgramImage2,
  HomeProgramImage3: HomeProgramImage3,
  homeLines: homeLines,
